describe('getImagesService', function(){
    ...
    describe('createImagesArray', function(){
        ...
        describe('the data taken by createdDomElm', function(){
            it('should not be undefined', function(){
                ImgService.createImagesArray(sampleJSON);
                expect(sampleJSON).should.not.equal('undefined');
            });
            it('should not be null', function(){
                ImgService.createImagesArray(sampleJSON);
                expect(typeof(sampleJSON)).should.not.equal('null');
            });
            it('should take an object', function(){
                ImgService.createImagesArray(sampleJSON);
                expect(typeof(sampleJSON)).to.equal('object');
            });
            it('should measure the length of the object inside photos.photo ', function(){
                expect(sampleJSON.photos.photo).should.exist;
            });
            it('length of object should return a number', function(){
                expect(typeof(sampleJSON.photos.photo.length)).to.equal('number');
            });
            it('should get the length of the object', function(){
                expect(sampleJSON.photos.photo.length).to.equal(2);
            });
        });
        describe('create an array with urls inside of it', function(){
            it('should return something', function(){
                expect(typeof(ImgService.createImagesArray(sampleJSON))).to.not.equal('null');
            });
            it('should get an array of urls as a return', function(){
        ...
        describe('it should concatenate the contents of the given object', function(){
